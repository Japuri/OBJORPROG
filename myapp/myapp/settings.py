...
SECRET_KEY = 'django-insecure-sd=2w1(0czc9e6wyjp(v@dhcpk6473ipsy2n84w4tq6d3)5r%^'
...
INSTALLED_APPS = [
    ...
    'main',
    'users', # <--- Add your new users app here
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug', # Add this if not present
...
# Where to redirect after a successful login (e.g., to the user's dashboard)
LOGIN_REDIRECT_URL = 'profile_dashboard' # We will define this URL name later
